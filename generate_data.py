...
def generate_vector(dim):
    # Using simple uniform random. For higher fidelity to embeddings, 
    # we could use Gaussian, but uniform is fine for functional testing.
...
print("Writing upsert_50k.json...")
with open("upsert_50k.json", "w") as f:
...
print("Writing search_1k.json...")
with open("search_1k.json", "w") as f:
